...
public interface IView {
    ...
    void mostrarHistorialCondensacion(List<RegistroSimulacion.SnapshotParticion> datos);

    void mostrarHistorialCompactacion(List<RegistroSimulacion.SnapshotMemoria> datos);
}